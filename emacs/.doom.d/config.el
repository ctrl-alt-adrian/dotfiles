...
;;
(load! "customConfig/web.el")
(load! "customConfig/treemacs.el")
(load! "customConfig/ui.el")
(load! "customConfig/treesitter.el")
(load! "customConfig/lsp.el")
(load! "customConfig/projectile.el")
